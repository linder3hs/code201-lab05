...
function testMultiply() {
  ...
  if (
    multiply(5, 9)[0] === 45 &&
    multiply(5, 9)[1] === "The product of 5 and 9 is 45."
  ) {
...
function testSumAndMultiply() {
  //eslint-disable-line
  if (
    sumAndMultiply(4, 7, 5)[0] === 16 &&
    sumAndMultiply(4, 7, 5)[1] === 140 &&
...
function testMultiplyAnyArray() {
  //eslint-disable-line
  if (
    multiplyAnyArray(testDynamicArray)[0] === 120 &&
    multiplyAnyArray(testDynamicArray)[1] ===
